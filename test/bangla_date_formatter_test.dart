...
void main() {
  group('BanglaDateFormatter', () {
    test('formats a date correctly', () {
      ...
      final formatter = BanglaDateFormatter('DD/MM/YYYY');
